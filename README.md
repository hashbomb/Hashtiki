...
HASHTIKI is a OEC NFT that will bring value to the NFT holders via free airdrop token, royalty sharing, and DAO treasury fund.



HashTiki is a collection of NFTs with fun concepts, innovative culture, and open ecology. Randomly generated by an algorithm, NFTs of HashTiki will track their ownership on the OEC blockchain and have cultural, entertainment, and collection value. 
